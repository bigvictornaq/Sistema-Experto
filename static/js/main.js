var questions = [
    ...
    {
        question: "Do you suffer from Restlessness?",
        choices: {
            yes: "yes",
            no: "no",
        },
    ...
    {
        question: "Do you feel like you're always tired?",
        choices: {
            yes: "yes",
            no: "no",
        },
    ...
    {
        question: "Do you have chess Pain?",
        choices: {
            yes: "yes",
            no: "no",
        },
    ...
    {
        question: "do you feel sick with a sore throat?",
        choices: {
            yes: "yes",
            no: "no",
        },
...
//Do you feel nauseous? do you feel sick with a sore throat
function quiz(){
    // stores HTML output
    var output = [];
